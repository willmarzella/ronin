...
def _tune_system(variant: str, config: Optional[Dict[str, Any]] = None) -> str:
    ...
    return (
        ...
        "infrastructure-as-code. (3) BULLET GRAMMAR: '[decision / workflow "
        "change / sign-off won] — [what was built that caused it] ([stack])'. "
        "The artifact sits in the subordinate clause, always present, never "
        "the subject. ORDER within each role: social-verification bullets "
