...
def _tune_system(variant: str, config: Optional[Dict[str, Any]] = None) -> str:
    ...
    return (
        ...
        "infrastructure-as-code. (3) Shape each bullet as build;outcome — the "
        "system engineered (named tech), semicolon, the measurable business "
        "result. (4) Blend three registers so seniority reads on every line: "
